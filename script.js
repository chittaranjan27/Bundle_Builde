document.addEventListener('DOMContentLoaded', () => {
  ...
  const updateUI = () => {
    ...
    if (numSelectedItems >= MIN_ITEMS_FOR_DISCOUNT) {
      ...
      bundleStatus.innerHTML = `Add at <strong>least ${MIN_ITEMS_FOR_DISCOUNT}</strong> products and <strong>Save 30%.`;
      ctaButton.innerHTML = `Add ${MIN_ITEMS_FOR_DISCOUNT} items to Proceed ${icons.cta}`;
